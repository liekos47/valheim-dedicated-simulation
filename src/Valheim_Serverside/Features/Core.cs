...
namespace Valheim_Serverside.Features
{
	public class Core : IFeature
	{
		...
		*/
		...
		{
			private static bool Prefix(ZoneSystem __instance, ref bool __result, Dictionary<Vector2s, ZoneSystem.ZoneData> ___m_zones)
			{
		...
		*/
		{
			...
			static bool Prefix(ZDOMan __instance, ref Vector3 refPosition, ref long uid)
			{
				...
				// 1.0 equivalent of the old FindSectorObjects(zone, m_activeArea, 0, ...) call.
